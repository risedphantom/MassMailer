...
namespace DKIM
{
	...
	public interface IPrivateKeySigner
	{
		...
		IPrivateKeySigner EnsureRsaSha1();
	}
	...
	public class PrivateKeySigner : IPrivateKeySigner
	{
		...
		public IPrivateKeySigner EnsureRsaSha1()
		{
			if (_algorithmInfo.SigningAlgorithm == SigningAlgorithm.RSASha1)
				return this;

			return new PrivateKeySigner(_key, SigningAlgorithm.RSASha1);
		}
